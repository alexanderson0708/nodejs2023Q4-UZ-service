...
export class Migration1687164344180 implements MigrationInterface {
  name = 'Migration1687164344180';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "fav_artist" ("id" SERIAL NOT NULL, "artistId" uuid NOT NULL, CONSTRAINT "PK_483d97db9d234bbb2188384d645" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "fav_album" ("id" SERIAL NOT NULL, "albumId" uuid NOT NULL, CONSTRAINT "PK_b6c134b9b6ac2d7b457782a86d1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "fav_track" ("id" SERIAL NOT NULL, "trackId" uuid NOT NULL, CONSTRAINT "PK_11f7c5379a0db5b3402b0d8ec33" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "password" character varying NOT NULL, "version" integer NOT NULL, "create" TIMESTAMP NOT NULL DEFAULT now(), "update" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
