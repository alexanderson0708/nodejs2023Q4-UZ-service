...
var ArtistEntity = /** @class */ (function () {
    function ArtistEntity() {
    }
    __decorate([
        (0, typeorm_1.PrimaryGeneratedColumn)('uuid')
    ], ArtistEntity.prototype, "id");
    __decorate([
        (0, typeorm_1.Column)({ name: 'name', type: 'varchar' })
    ], ArtistEntity.prototype, "name");
    __decorate([
        (0, typeorm_1.Column)({ name: 'grammy', type: 'boolean' })
    ], ArtistEntity.prototype, "grammy");
