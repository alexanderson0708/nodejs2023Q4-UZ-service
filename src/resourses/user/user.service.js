...
var UserService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        if (!user)
                            throw new common_1.NotFoundException("User with id:".concat(id, " is not exist"));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.userRepo.create({ login: login, password: hash })];
                    case 1:
                        newUser = _b.sent();
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (oldPassword === newPassword)
                            throw new common_1.ForbiddenException('You can not write the same password');
                        return [4 /*yield*/, this.userRepo.update(id, {
                                password: this.hashPassword(newPassword)
                            })];
                    case 2:
                        updateUser = _b.sent();
                        return [4 /*yield*/, this.userRepo.findOneBy({ id: id })];
    ...
    UserService.prototype["delete"] = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepo["delete"](id)];
                    case 1:
                        user = _a.sent();
                        if (!user.affected)
                            throw new common_1.NotFoundException("User with id:".concat(id, " is not exist"));
